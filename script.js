...
function save() {
    //get data from input
    var new_data = document.getElementById('nazivpesme').value;
    var new_data2 = document.getElementById('adresavidea').value;
    var new_data3 = document.getElementById('ocenapesme').value;
    var new_data4 = document.getElementById('domacastrana').value;

    //if there is nothing savedat the start then save an empty array
    ...
    old_data.push(new_data, new_data2, new_data3, new_data4);


    //save the old + new local storage
...
// if(localStorage.getItem('data') != null){
//     document.getElementById('pesmelista').innerHTML = JSON.parse(localStorage.getItem('data'));
// }